...
namespace Lab7._1
{
    class Program
    {
        ...
        public static void MPIMultiplicationMaster(Polynomial polynomial1, Polynomial polynomial2)
        {
            ...
            int end = 0;
            int length = 0;
            if (n - 1 != 0) { length = polynomial1.size / (n - 1); }
        ...
        public static void MPIMultiplicationWorker()
        {
            ...
            Polynomial result = Multiplications.MPIMultiply(polynomial1, polynomial2, begin, end);
        ...
        public static void MPIKaratsubaMaster(Polynomial polynomial1, Polynomial polynomial2)
        {
            ...
            {
                result = Multiplications.AsynchronousKaratsubaMultiply(polynomial1, polynomial2);
            }
            else
            {
        ...
        {
            Multiplications.MPIKaratsubaMultiply();
        }
